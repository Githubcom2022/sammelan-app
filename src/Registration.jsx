...
let Register = () => {
  ...
  let validate = () => {
    ...
    if (!state.username) {
      errorsData.username.push("Full Name can't be blank");
    }
  ...
  //     if (isValid()) {
  //       let response = await fetch("http://localhost:1454/users", {
  //         method: "POST",
  //         body: JSON.stringify({
  //           email: state.email,
  ...
  let onRegisterClick = async () => {
    ...
    if (isValid()) {
      try {
        ...
        console.error("API Error:", error);
        setMessage(<span className="text-danger">API request failed</span>);
      }
    } else {
      setMessage(<span className="text-danger">Errors</span>);
    }
      ...
      <div className="col-lg-6 col-md-7 mx-auto">
        <div className="card border-primary shadow my-2">
          ...
          <div className="card-body border-bottom">
            ...
            {/* username starts */}
            <div className="form-group form-row">
              <label className="col-lg-4" htmlFor="username">
                Full Name
              </label>
              <div className="col-lg-8">
                <input
